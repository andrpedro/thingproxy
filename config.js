...
exports.proxy_request_timeout_ms = 30000; // The lenght of time we'll wait for a proxy server to respond before timing out.
...
exports.max_requests_per_second = 2000; // The maximum number of requests per second to allow from a given IP.
